...
Table~\ref{tbl:ode} shows statistics about the interplants for each family of examples.
% apex_0_0_unsat

\begin{table}
\centering
\begin{tabular}{l|cccrrr}
Family            & \#tests    & ~\#flow &  ~\#var  & proof size      & ~interplant size & time \\
\hline
...
\begin{subfigure}{0.45\textwidth}
  ...
  \caption{ Interpolant for system of nonlinear ODEs } %TODO ref to formula
  \label{fig:ode}
\end{subfigure}
\hfill
